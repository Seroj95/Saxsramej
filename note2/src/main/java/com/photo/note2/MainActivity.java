...
//        database = NotesDatabase.getInstance(this);
        ...
        recyclerViewNotes = findViewById(R.id.reciverViewNotes);
//        if (notes.isEmpty()) {
//            notes.add(new Note(0"Title", "Descreption", "erekshbti", 2));
//            notes.add(new Note(1"Xanut", "gnel nor djins", "erekshbti", 1));
//            notes.add(new Note(2,"Js das", "anel Tnayiny", "choreqshabti", 1));
//        }
