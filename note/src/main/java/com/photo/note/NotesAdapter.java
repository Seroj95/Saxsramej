...
//notesViewHolder.textViewPriorety.setText(String.format(""+note.getPriroty()));

        int colorId;
        int proreti = note.getPriroty();
        switch (proreti){
            case 1:
...
//private TextView textViewPriorety;
        public NotesViewHolder(@NonNull View itemView) {
            ...
            textViewDayOfWeek=itemView.findViewById(R.id.textViewDayofWek);
//            textViewPriorety=itemView.findViewById(R.id.textViewPririvity);
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (onNoteClickListener!=null){
                        onNoteClickListener.onLogeClivk(getAdapterPosition());
                    }
                    return true;
                }
            });
